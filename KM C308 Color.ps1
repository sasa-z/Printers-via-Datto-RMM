...
$Global:ScriptName ="KM_Bizhub_C308"
$Global:ToastNotificationAppLogo = 'Printer.png'
$Global:ToastNotificationHeader = "KM Bizhub C308"
...
$driverName = "KONICA MINOLTA UNIVERSAL V4 PCL" #can be found in inf file under [driver name] section and it should be exactly the same here
...
if($OS -like "*Windows 10*"){
    $DriverURL = "https://raw.githubusercontent.com/sasa-z/Printers/main/Konica%20Minolta%20Bizhub%20C308/Win10/Driver.zip"
    send-log -logText "Driver for Windows 10 machine"

}elseif($OS -like "*Windows 11*"){
    $DriverURL = "https://raw.githubusercontent.com/sasa-z/Printers/main/Konica%20Minolta%20Bizhub%20C308/Win11/Driver.zip"
...
if ($env:PrinterName1){
    ...
    if ($env:PrintingDefaults1 -eq "BW1Sided"){
        $ConfigURL1 = "https://raw.githubusercontent.com/sasa-z/Printers/main/Konica%20Minolta%20Bizhub%20C308/Configurations/BW1Sided.xml"
        $portName1 =  $PrinterPortIP + "_BW"
        
        send-Log -logText "portName1: $portName1"
    }elseif($env:PrintingDefaults1 -eq "Auto1Sided"){
        $ConfigURL1 = "https://raw.githubusercontent.com/sasa-z/Printers/main/Konica%20Minolta%20Bizhub%20C308/Configurations/Auto1Sided.xml"
        $portName1 =  $PrinterPortIP + "_AUTO"
        
        send-log "portName1: $portName1"
    }elseif($env:PrintingDefaults1 -eq "Color1Sided"){
        $ConfigURL1 = "https://raw.githubusercontent.com/sasa-z/Printers/main/Konica%20Minolta%20Bizhub%20C308/Configurations/Color1Sided.xml"
...
if ($env:PrinterName2){ 
    if ($env:PrintingDefaults2 -eq "BW1Sided"){
        $ConfigURL2 = "https://raw.githubusercontent.com/sasa-z/Printers/main/Konica%20Minolta%20Bizhub%20C308/Configurations/BW1Sided.xml"
        $portName2 =  $PrinterPortIP + "_BW"
        
        send-log -logText "portName2: $portName2"
    }elseif($env:PrintingDefaults2 -eq "Auto1Sided"){
        $ConfigURL2 = "https://raw.githubusercontent.com/sasa-z/Printers/main/Konica%20Minolta%20Bizhub%20C308/Configurations/Auto1Sided.xml"
        $portName2 =  $PrinterPortIP + "_AUTO"
        
        send-log -logText "portName2: $portName2"
    
    }elseif($env:PrintingDefaults2 -eq "Color1Sided"){
        $ConfigURL2 = "https://raw.githubusercontent.com/sasa-z/Printers/main/Konica%20Minolta%20Bizhub%20C308/Configurations/Color1Sided.xml"
